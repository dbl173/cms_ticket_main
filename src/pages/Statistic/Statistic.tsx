...
import { Chart as ChartJs, Tooltip as TTooltip, Title, ArcElement, Legend } from 'chart.js';
    ...
    return (
        <Row className="statistic">
            ...
            <Col span={24} className="statistic-content">
                <Row justify="space-between" align="middle" className="statistic-content-title">
                    <span>Doanh thu</span>
            ...
            <Col span={24} className="statistic-content-chart">
                <Row className="statistic-content-chart-container">
                    <AreaChart width={1508} height={238} data={dataChart}>
                        ...
                        <Tooltip />
                        <Area type="monotone" dataKey="value" stroke="orange" fillOpacity={1} fill="url(#colorPv)" />
            ...
            <Col span={24} className="statistic-content-doanhthu">
                <span style={{ fontSize: '14px', color: '#1e0d83', opacity: 0.5 }}>Tổng doanh thu theo tuần</span>
            ...
            <Col span={24} className="statistic-content-chart-donut">
                <Row className="statistic-content-chart-donut-container">
                    ...
                    <Col span={6}>
                        <Row align="middle" justify="center" className="statistic-content-chart-donut-wrapper">
