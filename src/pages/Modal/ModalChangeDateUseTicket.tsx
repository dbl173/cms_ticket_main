...
const ModalChangeDateUseTicket: React.FC<IModalChangeDateUseTicketProps> = ({
    ...
    const hanleOnClickCloseModal = (event: React.MouseEvent<HTMLButtonElement>) => {
        handleCloseModal(event);
    };
    return (
        <Modal className="modal__change__date" visible={isVisibleShowModal} footer={null} closable={false}>
            <Form>
                <Row align="middle">
                    <Col
                        span={24}
                    ...
                    <Col span={18}>
                        ...
                        <DatePicker defaultValue={moment(ticket.ngaySuDung, format)} format={format} />
                    </Col>
                    <Col
                        span={24}
                        style={{
                    ...
                    >
                        <Space size={24}>
                            <Button
                                onClick={(e: React.MouseEvent<HTMLButtonElement>) => hanleOnClickCloseModal(e)}
